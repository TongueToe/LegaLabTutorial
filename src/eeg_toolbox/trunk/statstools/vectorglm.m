...
% 
% 
% [theta,H,LL,msg] = vectorlogistic(X,Y,ntrials)
% 
...
LL = sum(sparseblock(LLvec(theta),ntrials,'transpose')) - sum(sparseblock(thetafull.*(RM + L1reg.*sign(thetafull)),size(X,2),'transpose'));
