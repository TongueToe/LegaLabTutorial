...
%
%
%   result = writeToPage(page_name,text,action,[comment])
%
...
%
% To add a message to the edit log, pass it as a character string in the 'comment' argument.
%
%
...
res = mwapi(reqstr);
if isfield(res,'edit') && strcmpi(res.edit.result,'Success') && isfield(res.edit,'newrevid')
